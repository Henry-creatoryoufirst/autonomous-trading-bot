# MEDIC REPORT — 2026-04-21T21:06 UTC

## Status: API UNREACHABLE — Cannot Assess Bot Health (Persistent Issue — Run #16)

## Environment
- Run timestamp: 2026-04-21T21:06 UTC
- Medic agent: NVR Capital autonomous agent (hourly run)
- Working directory: /home/user/autonomous-trading-bot
- Current branch: claude/cool-sagan-6h08Q
...
| #16 | 2026-04-21T21:06 UTC | This report (same issue) |

## Bot Health Evidence (from git history)

Despite API being unreachable from medic, the repo reflects active bot development:
...
- `2026-04-21 (main)` — v21.17 dashboard-honesty: drawdownPct + regime wired into /api/sleeves/compare
- `2026-04-21 (main)` — v21.16 Phase 2: paper-trade simulation + Alpha Hunter v1 strategy
- `2026-04-20 21:09 UTC` — Scout added GHST (Aavegotchi) to TOKEN_REGISTRY
- `2026-04-20 (main)` — v21.14 asymmetric exit momentum + drawdown override (SPEC-015)
- `2026-04-20 (main)` — v21.13 Sleeves Phase 2 LIVE with SLEEVES_DRIVE_DECISIONS=true

**Note on v21.18 DRAWDOWN_OVERRIDE:** A "green-market loss gate" was blocking the bot from selling losing positions during drawdowns. This was patched — suggests the bot experienced or anticipated a drawdown period requiring override logic.

**Current main:** v21.19 with sleeves, Alpha Hunter, and drawdown safeguards active.
...
- **Scout**: SKIPPED — last scout ran at 2026-04-20T21:09 UTC (~24h ago, within 48h threshold). GHST added in that run.
...
- Report committed to claude/cool-sagan-6h08Q per session branch requirement

# MEDIC REPORT — 2026-04-17T06:22 UTC

## Status: API UNREACHABLE — Cannot Assess Bot Health (Persistent Issue — Run #6)

## Environment
- Run timestamp: 2026-04-17T06:22 UTC
- Medic agent: NVR Capital autonomous agent (hourly run)
- Working directory: /home/user/autonomous-trading-bot
- Current branch: claude/cool-sagan-v39O6
...
WebFetch https://api.geckoterminal.com/api/v2/networks/base/trending_pools
→ 403 Forbidden
```
...
| #6 | 2026-04-17T06:22 UTC | This report (same issue) |
...
**Run #6 Note:** Scout last ran 2026-04-16 05:15 UTC (~25h ago, within 48h window — skipped).
Auditor skipped again: cannot fetch live metrics; bear market params already tightened:
KELLY=0.35, VOL_TARGET=1.5%, BREAKER_DD=7%. Further blind tightening risks halting all trades.
...
- **Scout**: SKIPPED — last ran 2026-04-16 05:15 UTC (~25h ago, within 48h); also GeckoTerminal blocked

# MEDIC REPORT — 2026-04-26T00:00 UTC

## Status: API UNREACHABLE — Cannot Assess Bot Health (Persistent Issue — Run #19)

## Environment
- Run timestamp: 2026-04-26T00:00 UTC
- Medic agent: NVR Capital autonomous agent (hourly run)
- Working directory: /home/user/autonomous-trading-bot
- Current branch: claude/cool-sagan-XMRWM
...
| #19 | 2026-04-26T00:00 UTC | This report; scout: no qualifying tokens; auditor raised HOT_MOVER_MIN_BUY_RATIO 0.55→0.60 |
...
- **Scout**: No qualifying tokens found. Evaluated candidates: NORMIE ($147 vol, hacked — FAIL), A0X ($1,349 vol — FAIL), MOCHI ($1,702 vol — FAIL), EXTRA ($329 vol — FAIL), FLUID (no confirmed Base address — SKIP). GeckoTerminal API blocked. Standards maintained.
- **Auditor**: TRIGGERED (marketRegime BEAR 49+ days confirmed from git history). Research ran 4 searches. HOT_MOVER_MIN_BUY_RATIO 0.55→0.60 implemented (Impact 3, Complexity 1, Risk low, Priority 3.0). This is the last un-adjusted hot-mover gate after MIN_CHANGE was raised 5→7 in Run #18.

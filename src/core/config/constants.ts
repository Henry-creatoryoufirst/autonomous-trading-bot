...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor Jun-2026: tightened 7→6; completing 8→7→6 progression; industry standard 5-6% confirmed; 106-day bear + liquidate-all 2026-05-28)

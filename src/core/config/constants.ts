...
export const HOT_MOVER_MIN_FDV_USD = 1_000_000; // Bear-adjusted May-2026: 500K→1M — 70-day bear; MEV bots dominate micro-cap pumps on Base in sustained bear regimes (MEXC 2026 research); $500K-$1M FDV hot movers are overwhelmingly MEV-coordinated; $1M floor completes quality-gate set (pool age 24→48h ✓, volume 150K→200K ✓, FDV 500K→1M ✓)
...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 2 days in 80-day bear) */
export const CULL_MIN_AGE_HOURS = 48; // Bear-adjusted Jun-2026: 72→48 — 80-day bear (BTC -45% from Oct-2025 ATH $126K → $61K); sub-$100 research positions recycled 33% faster; deep bear confirms dead research positions drain alpha-strike reserve — faster rotation frees capital for quality-cohort entries on recovery signals; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards prevent culling genuine winners
...
export const DECEL_MIN_PROFIT_PCT = 2; // Bear-adjusted May-2026: 3→2 — 55-day bear; gains peak earlier/lower; lower floor lets sensitised DECEL (drop 8→6, Run#25) act on smaller winners before reversal

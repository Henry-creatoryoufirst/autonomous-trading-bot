...
export const HOT_MOVER_MIN_BUY_RATIO = 0.60; // Bear-adjusted Apr-2026: 0.55→0.60 — 46-day bear; 55% threshold lets in too many short-covering pumps that reverse; require clear buy majority

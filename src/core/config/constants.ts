...
export const BREAKER_DAILY_DD_PCT = 6;         // Bear-adjusted May-2026: 7→6 — 65-day bear; industry practice 5-6% (noted in Apr-2026 audit); mid-range alignment; pauses trading sooner on drawdown days, preserving capital for bear-market recovery; Kelly research confirms earlier circuit-breaker activation reduces ruin risk in sustained downtrends

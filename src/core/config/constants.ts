...
export const VOL_LOW_THRESHOLD = 1;            // <1% daily vol → increase size (bear-adjusted May-2026: boost reduced 1.5→1.2 — quiet periods in 53-day bear precede drops, not safe entries)
export const VOL_LOW_BOOST = 1.2;             // Bear-adjusted May-2026: 1.5→1.2 — hybrid Kelly+VIX research (arxiv 2508.16598) shows low-vol sizing boost should be conservative during bear regimes

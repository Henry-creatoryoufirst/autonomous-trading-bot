...
export const KELLY_ROLLING_WINDOW = 100;      // Auditor Apr-2026: expanded from 50 → 100 (research: 100+ trades for reliable win-rate/loss-ratio estimates; reduces noisy Kelly sizing in bear/volatile market)

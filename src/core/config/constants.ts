...
export const VOL_HIGH_THRESHOLD = 5;           // >5% daily vol → reduce size by 60% (was 8→6; bear-adjusted May-2026: 67-day bear; 5-6% daily vol range now routine in sustained bear; earlier VAPS trigger preserves capital through common bear-regime volatility spikes)

...
export const DEFAULT_REGIME_MULTIPLIERS = {
  ...
  TRENDING_DOWN: 0.65,  // auditor: Reduced from 0.85 — sustained BEAR market (6mo) warrants more capital protection; prior 0.6 was "defensive" but 0.85 overexposes in prolonged downtrend

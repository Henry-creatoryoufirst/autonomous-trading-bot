 ...
 */
export const KELLY_FRACTION = 0.25;           // Bear-adjusted Apr-2026: True Quarter-Kelly (was 0.35 ~third-Kelly); 56-day bear market — academic consensus 10-25% of full Kelly in sustained bear; 0.25×14%=3.5% effective max per trade

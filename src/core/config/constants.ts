...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor May-2026: tightened 7→6 — 65-day bear; industry practice 5-6% now achieved; drawdown-aware sizing research confirms tighter daily brake reduces bear-cascade damage; prior: 8→7 Apr-2026)

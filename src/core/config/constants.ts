 ...
 */
export const KELLY_FRACTION = 0.25;           // Bear-adjusted Apr-2026: True Quarter-Kelly (was 0.35); crypto positions highly correlated in bear (~1.0 pairwise), effective diversification ≈ 2-3 positions; 0.25×14%=3.5% effective max, reducing per-trade sizing ~28% vs 0.35

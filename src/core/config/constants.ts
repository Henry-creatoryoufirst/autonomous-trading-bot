...
export const STALE_POSITION_MIN_AGE_HOURS = 48; // Option B quality-cohort Jun-2026: 36→48 — BTC on-chain accumulation signals (declining exchange balances, LTH accumulation, MVRV not at peak); quality assets (cbBTC/WETH/LINK) consolidate 2-4 days before next leg — 36h was calibrated for bear-regime meme/AI churn, not quality-cohort patience; restores original pre-bear threshold; STALE_POSITION_MAX_GAIN_PCT=1 + DRAWDOWN_OVERRIDE=-8% guards unchanged

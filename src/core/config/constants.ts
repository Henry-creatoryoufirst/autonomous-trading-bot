...
export const VOL_HIGH_THRESHOLD = 8;           // >8% daily vol → reduce size by 60% (v21.8: raised from 5% — crypto regularly moves 3-7%/day, 5% was cutting size on normal-to-moderate vol days unnecessarily)

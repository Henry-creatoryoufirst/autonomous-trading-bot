...
export const STALE_POSITION_MIN_AGE_HOURS = 30; // Bear-adjusted Jun-2026: 36→30 — 80-day bear, BTC -18% in June alone ($73K→$59K); $100+ positions flat for 1.25 days are dead money in deepened downtrend; accelerates Option B dry-powder replenishment; STALE_POSITION_MAX_GAIN_PCT=1 + MAX_MOMENTUM_PCT=2 guards prevent exiting genuine winners

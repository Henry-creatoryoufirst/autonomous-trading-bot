...
export const STALE_POSITION_MIN_AGE_HOURS = 40; // Recovery-adjusted Jun-2026: 36→40 — CryptoQuant bull-bear cycle indicator turned GREEN (Coindesk 2026-05-12, first time since 2023); quality cohort (cbBTC/WETH/etc.) consolidates 36-40h before breakouts in early recovery; 4h extension reduces premature stale-exits during regime-shift; STALE_POSITION_MAX_GAIN_PCT=1 + MAX_MOMENTUM_PCT=2 guards unchanged

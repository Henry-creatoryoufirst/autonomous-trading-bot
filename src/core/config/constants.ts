...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 2 days in 77-day bear) */
export const CULL_MIN_AGE_HOURS = 48; // Bear-adjusted May-2026: 72→48 — 77-day bear; Kelly criterion volatility research: sustained bear regimes require accelerated capital rotation; stale sub-$100 positions after 2 days have <15% recovery probability; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards intact — genuine winners unaffected

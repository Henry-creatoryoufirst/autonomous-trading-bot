...
export const VOLUME_SPIKE_THRESHOLD = 2.5; // Bear-adjusted May-2026: 2.0→2.5 — 72-day bear; compressed Base volume (~$673M/day) makes 2× spikes indistinguishable from MEV noise; 2.5× requires genuine broad-market participation before alerting AI decision context

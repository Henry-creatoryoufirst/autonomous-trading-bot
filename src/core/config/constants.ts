 ...
 */
export const VOL_TARGET_DAILY_PCT = 1.25;      // Bear-adjusted May-2026: 1.5→1.25 — 85-day bear; risk-constrained Kelly research confirms tighter vol target reduces drawdowns in sustained bear regimes (Kelly Criterion for Crypto Traders 2026); VAPS further shrinks positions when daily vol exceeds target, complementing Quarter-Kelly (0.25) + KELLY_POSITION_CEILING_PCT (12)

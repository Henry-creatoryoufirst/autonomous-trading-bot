...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 2.5 days in 105-day bear) */
export const CULL_MIN_AGE_HOURS = 60; // Bear-adjusted Jun-2026: 72→60 — 105-day bear (40% longer than 65-day bear when 72h was set); capital recycling research basis unchanged; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards protect genuine winners

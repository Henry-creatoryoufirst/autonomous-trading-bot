...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor May-2026: tightened 7→6; 53-day bear market; industry practice 5-6%, Adaptive Kelly research confirms tighter drawdown controls in prolonged bear)

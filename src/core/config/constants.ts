...
export const KELLY_BEAR_REGIME_MULTIPLIER = 0.80; // Reduce Kelly ceiling 20% in BEAR/VOLATILE regime — regime-aware sizing: auditor Apr-2026, 46-day bear warrants auto-tightening when regime sensor fires

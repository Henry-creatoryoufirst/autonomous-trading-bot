...
export const DEFAULT_REGIME_MULTIPLIERS = {
  ...
  VOLATILE: 0.6,        // v9.4: Raised from 0.5; auditor May-2026: 0.7→0.6 — 55-day bear; volatile spikes are whipsaws not opportunity; keep TRENDING_DOWN(0.75) > VOLATILE(0.6) in bear

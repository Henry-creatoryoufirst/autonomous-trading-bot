...
export const KELLY_ROLLING_WINDOW = 30;       // Bear-adjusted Apr-2026: 50→30 — crypto best practice: recalibrate every 20-30 trades; 50-trade window ~12.5h lags regime shifts in fast-moving bear markets

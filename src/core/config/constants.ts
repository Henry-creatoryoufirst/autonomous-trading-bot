 ...
 */
export const KELLY_FRACTION = 0.25;           // Bear-adjusted Apr-2026-25: True Quarter-Kelly (was 0.35 → 0.5 half-Kelly); 46-day bear continues; research confirms 25% Kelly halves volatility with minimal return impact; 0.25×14%=3.5% effective max per trade

...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 2 days in 90-day bear) */
export const CULL_MIN_AGE_HOURS = 48; // Bear-adjusted Jun-2026: 72→48 — 90-day bear; continues 168→120→72→48 progression; dead sub-$100 research positions recycle 33% faster; Kelly criterion research confirms accelerated capital rotation in sustained bear regimes; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards prevent culling genuine winners

 ...
 */
export const KELLY_FRACTION = 0.40;           // 40% Kelly — bear-adjusted (was 0.5 Half Kelly); auditor Apr-2026: 46-day bear warrants sub-Half Kelly; reduces all avg positions ~20% vs prior ceiling-only fix

...
export const KELLY_ROLLING_WINDOW = 25;       // Bear-adjusted Apr-2026: 50→25 — faster adaptation; 50-trade window includes bull-era wins, inflating Kelly in bear markets; 25-trade window tracks recent reality

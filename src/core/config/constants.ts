 ...
 */
export const KELLY_FRACTION = 0.25;           // Bear-adjusted Apr-2026 Run#19: true quarter-Kelly (was 0.35); 49-day bear, crypto research consensus 10-25% Kelly; 0.25×14%=3.5% effective max vs 4.9% prior

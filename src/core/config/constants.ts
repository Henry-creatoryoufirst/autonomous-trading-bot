...
export const HOT_MOVER_MIN_LIQUIDITY_USD = 100_000; // Bear-adjusted Jun-2026: 75K→100K — 95-day bear + Aerodrome mandatory MEV-resistant pool migration (June 2026); LP providers shifting liquidity between pool versions temporarily reduces depth; F&G at 5 (Extreme Fear); $75K floor set pre-migration at 63-day bear; $100K floor cuts compounded slippage tail risk during migration window

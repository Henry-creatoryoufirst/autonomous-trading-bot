...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor May-2026: tightened 7→6 — 75-day bear; industry practice 5-6%; Apr-2026 auditor went 8→7 citing same standard; completing progression to industry floor)

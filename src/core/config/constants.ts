...
export const VOL_LOW_BOOST = 1.15;             // Bear-adjusted May-2026: 1.25→1.15 — 76-day bear; Fidelity 2026: cbBTC 30%+ below ATH, $80-90K range, 6-12mo recovery typical; calm windows in week-11 bear are consolidation/distribution, not bottoming; Kelly+VAPS research confirms further boost reduction controls overshoot risk in prolonged bear

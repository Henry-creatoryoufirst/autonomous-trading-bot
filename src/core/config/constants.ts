...
export const BREAKER_WEEKLY_DD_PCT = 12;       // 12% weekly drawdown → pause (auditor Apr-2026: 15→12; industry practice 7-10%, bear-market recovery asymmetry warrants earlier pause)

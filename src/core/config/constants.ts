...
export const VOL_HIGH_THRESHOLD = 5;           // >5% daily vol → reduce size by 60% (was 8→6; auditor Apr-2026: 5-6% daily vol routine in 46-day bear, extends VAPS protection to moderate-high vol range)

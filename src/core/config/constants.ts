...
export const NORMAL_CONFLUENCE_BUY = 28;    // Bear-adjusted May-2026: 27→28 — 78-day bear; Kelly research (2026) confirms "only bet when net edge exceeds threshold"; AriseAlpha & algorithmic competition on Base rising (2026-05-22); +1pt filters out marginal signals in crowded signal environment.

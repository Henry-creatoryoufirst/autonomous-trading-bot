...
export const KELLY_ROLLING_WINDOW = 20;       // Bear-adjusted May-2026: 30→20 — 54-day bear; aligns window with KELLY_MIN_TRADES so all 20 samples are recent; eliminates pre-bear bull-era wins that inflate Kelly estimate in sustained downtrends

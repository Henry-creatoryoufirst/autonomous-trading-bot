...
export const VWS_MIN_LIQUIDITY_USD = 25_000;       // Bear-adjusted Jun-2026: 20K→25K — 113-day bear + Aerodrome/Aero migration (July 2026); LPs migrating to new MEV-resistant pools create temporary liquidity fragmentation; $25K floor avoids routing through thin migrating pools during transition period; research: ainvest.com aerodrome-migration-july-2026

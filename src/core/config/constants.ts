...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 2 days in 82-day bear) */
export const CULL_MIN_AGE_HOURS = 48; // Bear-adjusted May-2026: 120→72→48 — 82-day bear; dead sub-$100 research positions recycle 33% faster (3 days → 2 days); Kelly criterion research confirms sustained bear regimes require accelerated capital rotation out of non-performing positions; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards prevent culling genuine winners

...
export const HOT_MOVER_MIN_LIQUIDITY_USD = 100_000; // Bear-adjusted May-2026: 75K→100K — 86-day bear; LP withdrawal thins $75K-$100K pools to 2-3× realized slippage; MEV sandwich frequency elevated at this tier (MEXC 2026 research); completes hot-mover quality-gate set (pool-age 24→48h ✓, vol 150K→200K ✓, FDV 500K→1M ✓, liquidity 75K→100K ✓)

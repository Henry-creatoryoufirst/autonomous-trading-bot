...
export const VOL_LOW_BOOST = 1.35;             // Bull-recovery June-2026: 1.25→1.35 — Base DEX volume hit record $3B (June 2026); 90-day bear → bull regime transition; low-vol (<1% daily) in recovering markets is accumulation, not pause-before-continuation; partial unwind of May-2026 bear cut (was 1.5), cautious step; Kelly+VAPS research confirms low-vol size boost should scale up in bull transitions

...
export const STAGNATION_THRESHOLD_HOURS = 8; // v12.2.7: 1h → 4h; auditor Apr-2026: 4h → 6h; auditor Jun-2026: 6h → 8h — F&G still extreme fear (23-26), post-liquidation fresh start; extends patience window to reduce forced exploration trades before real signal re-emerges in recovery phase

...
export const HOT_MOVER_MIN_LIQUIDITY_USD = 100_000; // Bear-adjusted Jun-2026: 75K→100K — 86-day bear; last remaining hot-mover quality gate not tightened during bear (vol 150K→200K ✓, FDV 500K→1M ✓, pool-age 24→48h ✓, buy-ratio 55→60% ✓); $75K pools in sustained downtrend carry high MEV-sandwich risk; $100K floor completes the quality-gate set

...
export const VOL_HIGH_THRESHOLD = 5;           // >5% daily vol → reduce size by 60% (was 8→6 bear-adj Apr-2026; 5→6% vol band still common in post-bear May-2026 recovery; earlier trigger maintains defensive posture)

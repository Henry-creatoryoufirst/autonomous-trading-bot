...
/** Minimum position age in hours before culling is considered (7 days → 5 days in 56-day bear → 3 days in 65-day bear → 4 days in bull recovery) */
export const CULL_MIN_AGE_HOURS = 96; // Bull-recovery Jun-2026: 72→96 — Base DEX hit ATH ($1.68B/day Aerodrome, $3B total); market recovery confirmed; extend cull window 3→4 days so recovering positions get extra runway; CULL_MAX_MOMENTUM=3% + CULL_MIN_PNL_PCT=-5% guards remain intact

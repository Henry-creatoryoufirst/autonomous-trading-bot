...
export const VOL_LOW_THRESHOLD = 2;            // Recovery-adjusted Apr-2026: 1→2 — VIX-rank Adaptive Kelly; 1.5× boost now fires at <2% daily vol (calm/recovering), not just <1% (near-never in crypto)

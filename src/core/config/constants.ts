...
export const KELLY_ROLLING_WINDOW = 100;      // Bear-adjusted Apr-2026: 50→100 — 100 trades gives statistically robust win-rate estimates; 50 was too noisy during volatile bear markets to produce reliable Kelly sizing

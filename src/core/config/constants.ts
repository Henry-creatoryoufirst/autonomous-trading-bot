...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor Jun-2026: tightened 7→6; June bear leg deepened to BTC $59K -19% (-2yr low), ETH $1.56K -22%; industry practice 5-6%; earlier circuit breaker protects against accelerating drawdown)

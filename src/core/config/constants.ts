 ...
 */
export const KELLY_FRACTION = 0.25;           // Bear-adjusted May-2026: 0.35→0.25 — 55-day bear; true Quarter-Kelly; research: 10-25% of full Kelly optimal for crypto fat tails in sustained bear; effective max 4.9%→3.5% portfolio per trade

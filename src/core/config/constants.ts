 ...
 */
export const KELLY_FRACTION = 0.4;            // 0.4 Kelly — bear-adjusted Apr-2026: 46-day bear → Quarter-Kelly range (was 0.5 Half Kelly); 2026 consensus: fractional ≤0.4 for extended bear drawdown control

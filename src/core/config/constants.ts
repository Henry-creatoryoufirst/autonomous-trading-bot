...
export const BREAKER_DAILY_DD_PCT = 6;         // 6% daily drawdown → pause (auditor Jun-2026: tightened 7→6 — 87-day bear; industry practice 5-6%; post-liquidate-all portfolio is full-USDC, first entries must be protected; 1h pause fires 1pp sooner to cap day-1 drawdown on re-entry)

...
export const CASH_DEPLOYMENT_CONFLUENCE_DISCOUNT = 12; // Bear-adjusted May-2026: 20→15 (63-day bear) → 15→12 (71-day bear); effective buy threshold for cash deployment 27-15=12→27-12=15; Kelly criterion + bear-market research: in sustained bear, idle-cash windows are pause-before-continuation; require stronger confluence before URGENT-tier deployment

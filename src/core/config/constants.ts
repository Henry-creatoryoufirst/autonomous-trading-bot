...
export const CULL_MIN_AGE_HOURS = 48; // Bear-adjusted Jun-2026: 72→48 — 84-day bear; Q2 2026 Kelly+friction research confirms dead sub-$100 positions in sustained downtrends rarely recover after 2 days; CULL_MAX_USD=100, CULL_MIN_PNL_PCT=-5, CULL_MAX_MOMENTUM=3 guards prevent culling winners; frees capital for quality-cohort alpha-strike reserve sooner

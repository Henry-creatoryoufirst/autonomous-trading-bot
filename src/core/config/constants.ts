...
export const VOL_LOW_BOOST = 1.5;              // Recovery-adjusted Jun-2026: 1.25→1.5 — Option B window closing Jun-15; post-bear low-vol periods are accumulation/consolidation before breakout, not pause-before-continuation-down; reverts bear-specific reduction (May-2026 65-day bear, now resolved); Kelly+VAPS: restoring pre-bear boost for quality-cohort recovery phase

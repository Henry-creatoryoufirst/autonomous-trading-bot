 ...
 */
export const KELLY_FRACTION = 0.30;           // Bull-adjusted Jun-2026: 0.25→0.30 — market regime BEAR→BULL (BTC dominance 58%, Bitcoin Season confirmed Jun-2026); Thorp half-Kelly research: gradient toward half-Kelly appropriate in bull transition; effective max 3.5%→4.2% portfolio per trade

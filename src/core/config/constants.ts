...
export const FLOW_REVERSAL_EXIT_BUY_RATIO = 40; // Recovery-adjusted Jun-2026: 38→40 — bear→recovery regime shift (AERO +30% Jun-16, BTC bounce, Option B window closed Jun-15); bear baseline 45-50% normalises to 55-60% in recovery; 38% threshold exits winning positions during normal corrective dips that then continue upward; restoring to bull-calibrated 40% reduces false exits in uptrend

...
export const FLOW_REVERSAL_EXIT_BUY_RATIO = 40; // Bull-recalibrated May-2026: 38→40 — BTC $68K (retraced from $122K ATH), bull-bear indicator green (May-12), ETH $2.27K; buy-ratio baselines recovering toward 55-60%; 38 exits winners too early in a recovering bull market; returning to original bull-calibrated value

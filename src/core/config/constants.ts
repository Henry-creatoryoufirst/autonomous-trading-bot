...
export const DECEL_MIN_PROFIT_PCT = 2; // Bear-adjusted Apr-2026: 3→2 — bear-market 3% gains evaporate before trim fires; lower threshold exits 1% earlier while DECEL_MIN_CYCLES=2 still filters noise

...
/** Hot mover quality gate: minimum buy ratio in h1 (60%+ buys = genuine demand, not sell-off) */
export const HOT_MOVER_MIN_BUY_RATIO = 0.60; // Bear-adjusted Apr-2026: 0.55→0.60 — 46-day bear; short-covering bounces clear 55% threshold frequently; require 60% for real accumulation signal

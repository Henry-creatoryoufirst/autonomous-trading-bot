 ...
 */
export const REENTRY_CONFLUENCE_BUY = 29;   // Bear-adjusted Jun-2026: 27→29 — 106-day bear, F&G 23-26 extreme fear; sentiment veto at extremes applies to buys (signal research 2026); kept aligned with NORMAL_CONFLUENCE_BUY (unified in May-2026).
export const REENTRY_CONFLUENCE_SELL = -23;  // v10.4: Narrowed from -28 — symmetrical 3pt premium above normal (-20)
export const NORMAL_CONFLUENCE_BUY = 29;    // Bear-adjusted Jun-2026: 27→29 — 106-day bear, F&G 23-26 extreme fear; research: macro sentiment at extremes is a veto condition on entry signals; was 25→27 at 46-day bear; further tightened at 106-day extreme fear.
